...
{	
	...
	std::string seg, seg2;
	int newSegmentId, newSegmentId2;
	...
	std::vector<TwoPaCo::JunctionPosition> start_contigs;
	std::vector<TwoPaCo::JunctionPosition> end_contigs;
